...
@Service
public class UserMailForPayment {

	public void triggerMailForPayment(String name, String emailId,String caseNbr) throws AddressException, MessagingException {
		System.out.println("Trigger Mail for Payment");
		...
		String messageBody = "<html>"
				...
				+ "				<div class=\"wysiwyg-text-align-center\" style=\"box-sizing: border-box; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0; text-align: center !important\" align=\"center\">Hi "+name
				+ "<br>"
				+ "				<div class=\"wysiwyg-text-align-center\" style=\"box-sizing: border-box; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0; text-align: center !important\" align=\"center\">You document is verfiy.Please click on below button to processed the payment"
		...
		DataSource fds1 = new FileDataSource(UserMailForFillDriverDetails.class
				.getResource("/1.png").getFile());
		messageBodyPart.setDataHandler(new DataHandler(fds1));
		messageBodyPart.setHeader("Content-ID", "<image1>");
		multipart.addBodyPart(messageBodyPart);

		messageBodyPart = new MimeBodyPart();
		DataSource fds2 = new FileDataSource(UserMailForFillDriverDetails.class
				.getResource("/2.jpg").getFile());
		messageBodyPart.setDataHandler(new DataHandler(fds2));
		messageBodyPart.setHeader("Content-ID", "<image2>");
		multipart.addBodyPart(messageBodyPart);

		messageBodyPart = new MimeBodyPart();
		DataSource fds3 = new FileDataSource(UserMailForFillDriverDetails.class
				.getResource("/3.jpg").getFile());
		messageBodyPart.setDataHandler(new DataHandler(fds3));
		messageBodyPart.setHeader("Content-ID", "<image3>");
		multipart.addBodyPart(messageBodyPart);

		messageBodyPart = new MimeBodyPart();
		DataSource fds4 = new FileDataSource(UserMailForFillDriverDetails.class
				.getResource("/4.jpg").getFile());
